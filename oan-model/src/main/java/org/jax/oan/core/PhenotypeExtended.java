...
public class PhenotypeExtended extends Phenotype {

	private PhenotypeMetadata metadata;
	private final String category;

	public PhenotypeExtended(TermId id, String name, String category, PhenotypeMetadata metadata) {
		super(id, name);
	...
	public boolean equals(Object o) {
		...
		PhenotypeExtended phenotype = (PhenotypeExtended) o;
